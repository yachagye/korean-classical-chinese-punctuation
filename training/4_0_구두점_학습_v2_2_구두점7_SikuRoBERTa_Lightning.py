...
7개 구두점 버전 - PatternAwareLoss 제거, 기본 BCE만 사용
"""
...
def main():
    ...
    trainer = pl.Trainer(
        ...
        deterministic=True,
        benchmark=False,  # 실험 비교 시 재현성 우선
        strategy='auto'
    )

    print("\n" + "=" * 50)
    print("L40S 48GB GPU 학습 시작!")
    print(f"모델: SikuRoBERTa")
    print(f"실제 학습 데이터: {actual_train_size:,}개")
    ...
    print(f"손실 함수: BCEWithLogitsLoss (기본)")
    print("=" * 50 + "\n")
